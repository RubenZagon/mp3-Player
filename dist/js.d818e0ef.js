...
var songs = ['https://scummbar.com/mi2/MI1-CD/01%20-%20Opening%20Themes%20-%20Introduction.mp3', 'https://scummbar.com/mi2/MI1-CD/02%20-%20Chapter%20Screen.mp3', 'https://scummbar.com/mi2/MI1-CD/03%20-%20The%20Scumm%20Bar.mp3'];
var currentSong = 0;
var audio = new Audio(songs[currentSong]); // Descarga la primera canción
...
function changeVolume(vol, name) {
  audio.volume = vol;
  buttons.volume.innerHTML = "<i class=\"fas fa-volume-".concat(name, "\"></i>");
}
...
function putText() {
  var nameSong = songs[currentSong];
  var cleanName = unescape(nameSong);
  var pos = cleanName.lastIndexOf('/') + 1;
  var shortName = cleanName.substring(pos);
  var miniName = shortName.replace('.mp3', '');
